...
clusters = dataset.join(predictions, dataset.listId == predictions.label)
clusters = clusters.drop('listId','features','label').rdd.filter(lambda x: x[13]==4)
...
# accommodates|bathrooms|bedrooms|beds|price|Shared room|Entire home/apt|Private room|Queens|Brooklyn|Staten Island|Manhattan|Bronx
